            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <strong>Επιλογή Εταιρείας Φύλαξης για εξαγωγή στοιχείων</strong>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('security.choose-export') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="d-flex">
                                    <label for="company" class="col-md-6 col-form-label text-md-right">Επιλέξτε Εταιρεία</label>
                                    <div class="col-md-6">
                                        ...
                                        @error('company')
                                        <strong>Παρακαλώ επιλέξτε Εταιρεία</strong>
                                        @enderror
                                    </div>
