...
<div class="container col-md-12 py-3 mt-4">
...
<footer>
    <div class="row">
        <div class="col-4 offset-8">
            <p class="text-center" style="margin-bottom: 80px;">Ο Επόπτης</p>
            <p class="text-center">{{ $user->name }} {{ $user->surname }}</p>
            <p class="text-center">{{ $user->tier}}</p>
        </div>
    </div>
</footer>
