...
<div class="container">
    ...
    <ul>
        <li>τις βεβαιώσεις των Εποπτών των κτηρίων του ΕΚΠΑ για το διάστημα από {{ $from }} μέχρι {{ $to }}<br></li>
    ...
    <p>ότι οι υπηρεσίες φύλαξης στα κτήρια του ΕΚΠΑ για το χρονικό διάστημα από {{ $from }} έως {{ $to }} έχουν παρασχεθεί σύμφωνα με τις
