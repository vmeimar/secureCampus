...
<head>
    {{--    <meta charset="UTF-8">--}}
    <title>ΠΡΩΤΟΚΟΛΛΟ ΤΡΙΜΕΛΟΥΣ ΕΠΙΤΡΟΠΗΣ</title>
...
{{--    <div class="row col-md-4 float-left" style="left: 0"><p><strong>Προς: Επιτροπή Παραλαβής των υπηρεσιών φύλαξης του Ε.Κ.Π.Α.</strong></p></div>--}}
    <div class="row col-md-8" style="margin-left: 110px"><p><u><strong>ΠΡΩΤΟΚΟΛΛΟ ΤΡΙΜΕΛΟΥΣ ΕΠΙΤΡΟΠΗΣ</strong></u></p></div>
    <div class="row">
        <p>Οι κάτωθι  υπογεγραμμένοι:</p>
    </div>
    <div class="row">
        <ol>
            <li>Βαλάκος Ευστράτιος, Μέλος ΔΕΠ Τμήματος Βιολογίας</li>
            <li>Νοτάρης Σωτήριος, Μέλος ΔΕΠ Τμήματος Μαθηματικού</li>
            <li>Νοτάρης Σωτήριος, Μέλος ΔΕΠ Τμήματος Μαθηματικού</li>
        </ol>
    </div>
    <div class="row">
        <p>οι οποίοι αποτελούμε την Κεντρική Επιτροπή Παραλαβής υπηρεσιών φύλαξης των κτηρίων του ΕΚΠΑ
        σύμφωνα με την 123η / 2018-2019 Πράξη Πρύτανη (ΑΔΑ: ΨΠΞΦ46ΨΖ2Ν-2ΝΟ), αφού λάβαμε υπόψη :</p>
    </div>
        <div class="row">
        <ul>
            <li>τις βεβαιώσεις των Εποπτών των κτηρίων του ΕΚΠΑ για το διάστημα από 01.12.2019 μέχρι 31.12.2019</li>
            <li>την επικοινωνία με τους Επόπτες για την καταγραφή τυχόν παρατηρήσεών τους</li>
            <li>τους όρους της από 23.04.2019 σύμβασης (ΑΔΑΜ : 19SYMV004853037).</li>
            <li>την υπεύθυνη δήλωση του διευθύνοντα συμβούλου της εταιρείας  MY SERVICES SECURITY AND FACILITY Α.Ε.
                για την τήρηση της υποκείμενης εργατικής νομοθεσίας για τον μήνα  Νοέμβριο 2019, όσον αφορά υποχρεώσεις
                της εταιρείας για την υγεία, ασφάλεια και ασφάλιση του προσωπικού της εταιρείας που απασχολείται στη
                φύλαξη του ΕΚΠΑ, καθώς και την καταβολή όλων των νόμιμων αποδοχών στους παραπάνω εργαζόμενους (ΕΠΙΣΥΝΑΠΤΕΤΑΙ)</li>
            <li>τα δικαιολογητικά που κατέθεσε η Εταιρεία</li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-8" style="margin-left: 200px"><p><u><strong>βεβαιώνουμε</strong></u></p></div>
    </div>
        <div class="row">
        <p>ότι οι υπηρεσίες φύλαξης στα κτήρια του ΕΚΠΑ για το χρονικό διάστημα από 01.2 έως 31.12.2019 έχουν παρασχεθεί
            σύμφωνα με τις προβλεπόμενες ώρες της από 23.04.2019 σύμβασης εκτός από εκείνες που αναφέρονται στο Παράρτημα A
            του παρόντος και αποτελεί αναπόσπαστο τμήμα αυτού όπως και τo Παράρτημα Β.
            Επιπλέον, από τον έλεγχο των βεβαιώσεων των εποπτών διαπιστώθηκε ότι απασχολήθηκαν φύλακες υπερωριακά (Παράρτημα Β).
        </p>
    </div>
    <div class="row">
        <div class="col-md-8" style="margin-left: 200px"><p>Η Επιτροπή</p></div>
    </div>
    <div class="row">
