...
{{--                <tr>--}}
{{--                    <th scope="row">{{ $data['surname'] }} {{ $data['name'] }}</th>--}}
{{--                    <td>{{ $data['weekday_morning'] + $data['weekday_evening'] }}</td>--}}
{{--                    <td>{{ $data['weekday_night'] }}</td>--}}
{{--                    <td>{{ $data['holiday_morning'] + $data['holiday_evening'] }}</td>--}}
{{--                    <td>{{ $data['holiday_night'] }}</td>--}}
...
<div class="row">
    ...
    <table id="table" class="table table-striped table-bordered table-sm">
        ...
        <tr>
            <th>Φύλακας</th>
            <th>Εργάσιμες Πρωί/Απόγευμα</th>
            <th>Εργάσιμες Βράδυ</th>
            <th>Κυρ./Αργίες Πρωί/Απόγευμα</th>
            <th>Κυρ./Αργίες Βράδυ</th>
            <th>Ισοδύναμες Ώρες</th>
        </tr>
        </thead>
        <tbody>
        @foreach($exportData as $data)
            <tr>
                <td>{{ $data['surname'] }} {{ $data['name'] }}</th>
                <td>{{ $data['weekday_morning'] + $data['weekday_evening'] }}</td>
                <td>{{ $data['weekday_night'] }}</td>
                <td>{{ $data['holiday_morning'] + $data['holiday_evening'] }}</td>
                <td>{{ $data['holiday_night'] }}</td>
