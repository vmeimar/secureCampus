                        ...
                        <div class="d-flex justify-content-center mb-4">
                            <div class="row col-md-8">
                                <h6 class="justify-content-center">
                                    <strong>
                                        Έχετε τη δυνατότητα να εξάγετε αρχείο τύπου Pdf για τις βάρδιες όλων των φυλάκων της εταιρείας
                                        {{ $company->name }} ανά μήνα με τις ώρες εργασίας και τις ισοδύναμες ώρες ημερήσιας καθημερινής βάρδιας.
                                    </strong>
                                </h6>
                            </div>
                        </div>
